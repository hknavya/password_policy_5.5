...
Description: user registration with extra validation for password.
...
class RegisterController extends Controller {
	...
	public function do_register() {
		...
		PasswordPolicy::validatePassword($username,$password,$e);
		...
		if (!$e->has()) {
			...
			if (is_object($process)) {
				...
				$password = $process->getUserPassword();
				$userId = $process->getUserID();
				$userName = $process->getUserName();
				$userEmail = $process->getUserEmail();
				/*saves the registered user information into the database*/
				PasswordPolicy::savePassword($password,$userId,$userName,$userEmail);
